...
| Polaris Admin Tool | `1.6.0` companion application (2026-07-09) | PR #88 merged the repository-owned publisher for `ghcr.io/tommykammy/shirokuma-polaris-admin:1.6.0-arm64`; first quarantine digest `sha256:78a4d4f4609dfc58d6c43526ab9ea198dea2427415ad7ce86fbf2e34e76b9a84` is rejected, and the approved correction repins only the Admin image to Amazon Corretto 21 Alpine 3.24 arm64 manifest `sha256:dc43b39c47f1729dc772a9b8af7222757fac6c8cfa8a0802829af665b1c89925` | Run `29798208118` proved native arm64 build and CLI smoke but found High 19/Critical 0 in the Amazon Linux 2023 base. Alpine index `sha256:30b1b2246cee9a98c9bf8a11537a04f1eaf8c59279b0c70ae02d7e5b934edeaa` contains the approved arm64 candidate; registry history reports Corretto `21.0.11.10.1`, `/usr/bin/java` is present, and focused Trivy 0.72.0 reports High=0/Critical=0. | Apache-2.0 | ASF PGP/SHA-512 source, exact dependency OCI `ghcr.io/tommykammy/shirokuma-polaris-admin-gradle-dependencies@sha256:7a505defcd78c7a7b978e88cd4c72e0a5d8b69cbb57ddd311c163b09fe789d18`, fresh network-none/offline/strict build, keyless signature, provenance, SBOM, scan, and exact CLI smoke remain required; run `29798208118` stopped before signature/provenance/evidence. | `admin_image_publication_pending`; Alpine repin and a full successful main publication are required before `admin_image_evidence_review_pending`. Image admission, credentials, runtime, and Flux remain blocked. | Owner: WP-L1-LAKE-002. Risk: upstream Admin dependencies include NoSQL/MongoDB, while a mutable base tag, local zero-finding scan, or successful help smoke is not resident admission. Replace: keep catalog activation blocked until the repinned exact digest and complete evidence pass separate review and admission. | [release](https://github.com/apache/polaris/releases/tag/apache-polaris-1.6.0), [Admin Tool](https://polaris.apache.org/releases/1.6.0/admin-tool/), [PR #88](https://github.com/TommyKammy/Shirokuma/pull/88), [failed publication run](https://github.com/TommyKammy/Shirokuma/actions/runs/29798208118), [Corretto image](https://hub.docker.com/_/amazoncorretto) |
