...
|---|---|---|---|---|---|---|---|---|
| Trino | `483` (2026-07-17) | blocked upstream index `docker.io/trinodb/trino@sha256:db58cc93e593a2706553745f276bb119c9810e69918be56ecde088ba7ccb0534`; ADR-0022 selects a repository-owned source-build candidate, ADR-0023 provisionally authorizes only the exact source input, and ADR-0031 activates exact sequence 7 after retaining consumed sequence 6 run `32315191436` | The index contains `linux/amd64`, `linux/arm64`, and `linux/ppc64le`; the arm64 child is `sha256:aa18e61b2e7776ab8641ba8baaa8687d0430894e88c639e61010cc46a994ab36`. The contract pins Maven/Temurin builder index `sha256:7e461cec477077c1d9e50b13df8aef9018764410f4c4cd7c34803f10c4c99e4c` with native arm64 child `sha256:5476bfca9d0a6485b7161f6863123f7e6822336de4177273b47b5ec38ffd573a`, plus the future Corretto Alpine 3.24 arm64 base. | Apache-2.0 | The index has no attestation manifest or trusted signer; both annotated tag object `32d4f28e8311ea6f67edca209df59a0493d869fa` and source commit `50b0b50b75abd47f830b7805ee1b51716eb4065e` are unsigned; no trusted SLSA provenance binds the exact source coordinates to an approved publisher identity. | mainline ADR-0022 source-build candidate; `dependency_snapshot_publication_pending` under ADR-0031. Sequence 6 run `32315191436` failed closed with `BUN_SNAPSHOT_IDENTITY`; publish was skipped, no artifact was retained, and registry authentication or write was not reached. Only focused PR #155 and one sequence 7 attempt are authorized; rerun and sequence 8 remain forbidden. Dependency admission, image publication, resident admission, Flux, and runtime remain blocked. The signed 476 fallback is rejected because its unapproved trust root and Critical=2/High=52 fail admission. | Owner: WP-L1-QUERY-001 / Issue #63. Risk: the exact source publisher remains unauthenticated; SHA pinning or Shirokuma re-signing does not establish upstream identity. Controls: maximum 30 days, no automatic renewal, owner/reviewer separation, synthetic/PoC data only, no public exposure, no stacked vulnerability exception, and High=0/Critical=0 plus all downstream build/admission evidence. Replace: authenticate the exact source or a 480-or-newer release, then complete the repository-owned reproducible source build; otherwise fail closed at expiry. | [483 release](https://github.com/trinodb/trino/releases/tag/483), [ADR-0031](../07_ADR/ADR-0031_Activate_exact_Trino_483_dependency_publication_sequence_7.md), [sequence 6 run](https://github.com/TommyKammy/Shirokuma/actions/runs/32315191436), [476 feasibility](107_Trino_476_Signed_Distribution_Feasibility.md), [license](https://github.com/trinodb/trino/blob/483/LICENSE) |
...
Only focused PR #155 and one sequence-7 attempt are active; rerun and sequence 8
remain forbidden. The build
