...
`mac-studio-solo/local-lite` PoC through `2026-09-17T02:15:58Z`, and authorizes
exactly one sequence 6 dependency-snapshot publication attempt after focused PR
#153 merges with its final-head gates satisfied. No sequence 6 dependency
artifact exists yet. The build design selects native-arm64 Maven/Temurin builder index
