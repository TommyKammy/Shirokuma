...
|---|---|---|---|---|---|---|---|---|
| Trino | `483` (2026-07-17) | blocked upstream index `docker.io/trinodb/trino@sha256:db58cc93e593a2706553745f276bb119c9810e69918be56ecde088ba7ccb0534`; ADR-0022 selects a repository-owned source build | The index contains `linux/amd64`, `linux/arm64`, and `linux/ppc64le`; the arm64 child is `sha256:aa18e61b2e7776ab8641ba8baaa8687d0430894e88c639e61010cc46a994ab36`. The selected Maven/Temurin builder and Corretto Alpine 3.24 runtime candidates also have native arm64 manifests. | Apache-2.0 | The index has no attestation manifest or trusted signer, annotated tag object `32d4f28e8311ea6f67edca209df59a0493d869fa` is unsigned, and no trusted SLSA statement binds the image or server asset to commit `50b0b50b75abd47f830b7805ee1b51716eb4065e`. | mainline candidate; ADR-0022 accepts the source-build design, but dependency publication, image publication, resident admission, and runtime remain blocked by separate reviews. | Owner: WP-L1-QUERY-001. Risk: re-signing the untrusted upstream image would launder missing source and publisher identity. Replace: execute the ADR-0022 repository-owned reproducible source build with authenticated Maven closure, offline build, native arm64 smoke, signature, provenance, SBOM, and fresh scan evidence, or keep Trino blocked. | [release](https://github.com/trinodb/trino/releases/tag/483), [image tags](https://hub.docker.com/r/trinodb/trino/tags?name=483), [license](https://github.com/trinodb/trino/blob/483/LICENSE) |
...
ADR-0022 completed the source-build decision on 2026-07-22 without enabling a
publisher. It selects native-arm64 Maven/Temurin builder index
