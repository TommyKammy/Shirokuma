...
|---|---|---|---|---|---|---|---|---|
| Trino | `483` (2026-07-17) | blocked upstream index `docker.io/trinodb/trino@sha256:db58cc93e593a2706553745f276bb119c9810e69918be56ecde088ba7ccb0534`; ADR-0022 selects a conditional repository-owned source-build candidate | The index contains `linux/amd64`, `linux/arm64`, and `linux/ppc64le`; the arm64 child is `sha256:aa18e61b2e7776ab8641ba8baaa8687d0430894e88c639e61010cc46a994ab36`. The selected Maven/Temurin builder and Corretto Alpine 3.24 runtime candidates also have native arm64 manifests. | Apache-2.0 | The index has no attestation manifest or trusted signer; both annotated tag object `32d4f28e8311ea6f67edca209df59a0493d869fa` and source commit `50b0b50b75abd47f830b7805ee1b51716eb4065e` are unsigned; no trusted SLSA provenance binds the exact source coordinates to an approved publisher identity. | mainline candidate blocked at source authentication under ADR-0022; dependency publication, image publication, resident admission, and runtime remain blocked. The signed 476 fallback is separately rejected because its unapproved trust root and fresh scan with Critical=2/High=52 fail admission. | Owner: WP-L1-QUERY-001. Risk: SHA pinning, a self-selected signing key, Shirokuma re-signing, or downgrade to vulnerable 476 would weaken the trust boundary. Replace: authenticate an exact Trino 480-or-newer repository, tag, commit, and tree using an approved upstream signature, signed source release with approved trust root, or trusted provenance, then pass fresh High=0/Critical=0 before executing the repository-owned reproducible source build; otherwise keep Trino blocked. | [483 release](https://github.com/trinodb/trino/releases/tag/483), [476 feasibility](107_Trino_476_Signed_Distribution_Feasibility.md), [image tags](https://hub.docker.com/r/trinodb/trino/tags?name=483), [license](https://github.com/trinodb/trino/blob/483/LICENSE) |
