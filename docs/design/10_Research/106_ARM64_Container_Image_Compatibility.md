...
| Polaris Admin Tool | `1.6.0` companion application (reviewed 2026-07-21) | `ghcr.io/tommykammy/shirokuma-polaris-admin@sha256:a56d09406c9dc1602cc49c0e792035c1163abf0e975fe702ef7e775c445317dd`; Amazon Corretto 21 Alpine 3.24 arm64 base manifest `sha256:dc43b39c47f1729dc772a9b8af7222757fac6c8cfa8a0802829af665b1c89925` | Main run `29807128630` attempt `1` proved native linux/arm64, Java `21.0.11`, Alpine `3.24.1`, network-none CLI smoke, and anonymous exact-digest retrieval. | Apache-2.0 | ASF PGP/SHA-512 source, exact dependency OCI `ghcr.io/tommykammy/shirokuma-polaris-admin-gradle-dependencies@sha256:7a505defcd78c7a7b978e88cd4c72e0a5d8b69cbb57ddd311c163b09fe789d18`, fresh network-none/offline/strict build, Cosign/Rekor, SLSA v1, CycloneDX 1.7 (1,618 components with NoSQL/MongoDB), Trivy 0.72.0 High=0/Critical=0, attestations, and 35-file checksum closure. | `admin_image_admission_pending` after the evidence-only review; exact image is reviewed but not yet admitted. Credentials, runtime, resident ledger, and Flux remain blocked. | Owner: WP-L1-LAKE-002. Risk: a mutable trusted tag or evidence review is not resident admission. Replace: keep catalog activation blocked until separate exact-digest admission and runtime acceptance complete. | [release](https://github.com/apache/polaris/releases/tag/apache-polaris-1.6.0), [Admin Tool](https://polaris.apache.org/releases/1.6.0/admin-tool/), [PR #90](https://github.com/TommyKammy/Shirokuma/pull/90), [successful publication run](https://github.com/TommyKammy/Shirokuma/actions/runs/29807128630), [Corretto image](https://hub.docker.com/_/amazoncorretto) |
...
the mutable tag remains a pointer only. The next evidence-only review retains
and hash-binds the exact 35-file closure, then retires the publisher and moves
only to `admin_image_admission_pending`. Admission and all runtime gates remain
