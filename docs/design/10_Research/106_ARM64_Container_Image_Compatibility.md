...
|---|---|---|---|---|---|---|---|---|
| Trino | `483` (2026-07-17) | blocked upstream index `docker.io/trinodb/trino@sha256:db58cc93e593a2706553745f276bb119c9810e69918be56ecde088ba7ccb0534`; mainline ADR-0022 repository-owned source-build candidate; ADR-0033 authorizes only focused PR #158 and one separately approved automatic sequence-8 publication attempt | The upstream index contains `linux/amd64`, `linux/arm64`, and `linux/ppc64le`; the arm64 child is `sha256:aa18e61b2e7776ab8641ba8baaa8687d0430894e88c639e61010cc46a994ab36`. The contract pins Maven/Temurin builder index `sha256:7e461cec477077c1d9e50b13df8aef9018764410f4c4cd7c34803f10c4c99e4c` with native arm64 child `sha256:5476bfca9d0a6485b7161f6863123f7e6822336de4177273b47b5ec38ffd573a`, plus Corretto index `sha256:32d81edae73e1670244827c2f12e5bcf0d335f035b538455fe9d02eb0771d41b` and arm64 child `sha256:da20e1e0a2004dfb95e963d6ad978b5c0effdfc7000bce6a68836058ef24b427`. | Apache-2.0 | The index has no attestation manifest or trusted signer; both annotated tag object `32d4f28e8311ea6f67edca209df59a0493d869fa` and source commit `50b0b50b75abd47f830b7805ee1b51716eb4065e` are unsigned; no trusted SLSA provenance binds the exact source coordinates to an approved publisher identity. | mainline ADR-0022 source-build candidate; `dependency_snapshot_publication_pending` under ADR-0033. Sequence 7 run `32786095668` failed closed with `MAVEN_SCAN_FINDING` at Critical=0/High=3. PR #157 run `33026390700` proved the exact remediation at raw High=0/Critical=0. PR #158 creation does not authorize merge; after separate approval, exactly one automatic attempt 1 is permitted. The 476 fallback remains rejected at Critical=2/High=52. Dependency admission, image publication, resident admission, Flux, and runtime remain blocked. | Owner: WP-L1-QUERY-001 / Issue #63. Risk: the exact source publisher remains unauthenticated; SHA pinning or Shirokuma re-signing does not establish upstream identity. Controls: exact predecessor/final-head binding, expiry `2026-09-05T04:48:07Z`, no rerun or renewal, synthetic/PoC data only, no public exposure, and raw High=0/Critical=0 without OpenVEX or waiver. Replace: authenticate the source or adopt a 480-or-newer release, then complete the repository-owned reproducible source build. | [483 release](https://github.com/trinodb/trino/releases/tag/483), [ADR-0033](../07_ADR/ADR-0033_Activate_exact_Trino_483_dependency_publication_sequence_8.md), [PR #157 feasibility run](https://github.com/TommyKammy/Shirokuma/actions/runs/33026390700), [sequence 7 run](https://github.com/TommyKammy/Shirokuma/actions/runs/32786095668), [license](https://github.com/trinodb/trino/blob/483/LICENSE) |
...
remediation with raw High=0/Critical=0. ADR-0033 now authorizes only focused
PR #158 and, after a separate merge approval, one automatic sequence-8 attempt
from exact predecessor `1f4e2ce0b958f69c91780857b11695ac47d1e00a` before
`2026-09-05T04:48:07Z`. Dependency admission and every downstream boundary
remain forbidden. The build design selects native-arm64 Maven/Temurin builder index
