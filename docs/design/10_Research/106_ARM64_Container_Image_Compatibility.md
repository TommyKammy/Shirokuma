...
as unsigned. ADR-0023 explicitly accepts only this residual source-identity risk
for the exact coordinates and the bounded `mac-studio-solo/local-lite` PoC from
`2026-07-22T22:43:36Z` through `2026-08-21T22:43:36Z`. It permits review of the
dependency-snapshot contract, not a publisher or artifact. The later build
