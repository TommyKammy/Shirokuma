...
- Runtime phase-2 Draft PR #72で、main限定dependency snapshot publisherと
  schema-v2 verification contractをreview中です。
...
- このfeature PRでは未知のmain-run digestを自己承認しません。merge後のmain
...
- Draft PR #72は`Refs #61`を使用し、`Closes #61`を使用しません。Issue #61は
...
- Runtime phase-2 Draft PR:
  [#72](https://github.com/TommyKammy/Shirokuma/pull/72) (review中, `Refs #61`)
- Runtime follow-up depends on: `#27` (closed prerequisite checkpoint)
- Execution order: `1 of 8`
- Queue: PR #72 dependency snapshot publisherのreview、merge後main run、
