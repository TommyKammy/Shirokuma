...
- 修復Draft PR #76は、bounded candidate root内のsubshellでORASを実行し、
  ...
  workflow auditでfail-closedに拒否します。
...
- Gradle verified-closure projection repair PR:
  ...
  (merged, `Refs #61`)
- ORAS relative-layer path repair Draft PR:
...
- Queue: PR #76 ORAS relative-layer path repairのreview/merge、新しいmain run、
