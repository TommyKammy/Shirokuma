...
- 修復Draft PR #74は、同じsafe file streamからSHA-256と非security用途SHA-1を
  ...
  uppercase、nonhex、41–64桁、descriptor/archive再結合をfail-closedで拒否します。
...
- Gradle cache identity repair Draft PR:
  [#74](https://github.com/TommyKammy/Shirokuma/pull/74) (review中, `Refs #61`)
- Runtime follow-up depends on: `#27` (closed prerequisite checkpoint)
- Execution order: `1 of 8`
- Queue: PR #74 Gradle cache identity repairのreview/merge、新しいmain run、
