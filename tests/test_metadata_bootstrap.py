...
class MetadataBootstrapPrerequisiteTests(unittest.TestCase):
    def test_approved_trino_runtime_is_materialized(self) -> None:
        ...
        self.assertEqual(
            [],
            missing,
            "METADATA_TRINO_RUNTIME_PREREQUISITE_MISSING "
            "OpenMetadata ingestion stays blocked until the repository contains "
